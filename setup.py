...
setup(name="RL",
      version="0.1",
      description= "Package implementing various RL-Algorithms that can be applied to all environments with certain methods.",
      packages=[r"D:\Damian\PC\Python\ML\RL\Blueprints"],
      author= "Damian G."
      )
