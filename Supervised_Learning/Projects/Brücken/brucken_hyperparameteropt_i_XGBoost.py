...
xgboost_opt = gp_minimize(model_eval_xgboost, [Real(0, 20), Real(0.001, 0.5), Integer(3, 10), Integer(10, 2000), Real(0.5, 1), Integer(1, 10), Real(0, 10), Real(0, 10)], n_calls = 25)
