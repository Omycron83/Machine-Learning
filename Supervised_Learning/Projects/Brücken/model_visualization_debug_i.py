...
#Loading in the data and preparing it
data = pd.read_csv("DatensatzTraining_i.csv")
...
val_lin = k_fold_cross_val_mapes(10, train_data, labels, data_id, lin_model.ridge_normal_eq, cost)

np.savetxt(r"LinRegr_Mapes_i.csv", val_lin, delimiter=",")
...
val_nn = k_fold_cross_val_mapes(10, train_data, labels, data_id, nn_train, nn_cost)
np.savetxt(r"NN_Mapes_i.csv", val_nn, delimiter=",")
"""
...
np.savetxt(r"XGBoost_Mapes_i.csv", val_xgboost, delimiter=",")